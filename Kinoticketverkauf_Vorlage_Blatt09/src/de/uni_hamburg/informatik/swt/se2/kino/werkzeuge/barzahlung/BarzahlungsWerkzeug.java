...
//        {
            ...
            _ausreichenderGeldbetrag = eingabeBetrag.greaterEqualsThan(_preis) && eingabeBetrag.getzulaessig();
            int differenz = eingabeBetrag.sub(_preis).toInt();
